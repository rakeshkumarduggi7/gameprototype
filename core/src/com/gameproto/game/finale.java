...
public class finale implements Screen {
    gameproto gp;
    BitmapFont bmf;
    ...
    SpriteBatch batch;
    String s; String x;
    public finale (gameproto gp){
        this.gp=gp;
        x="louis is sent out with the pendant after few hundred meters of walking away from the station louis is disappeared in the dark night as the soldiers are watching from inside the station.\n" +
                "louis : (holding the pendant) take me home.\n" +
                "ben : take me to where louis went";
