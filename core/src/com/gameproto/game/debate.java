...
public class debate implements Screen {
 ...
 public debate(gameproto gp){
    this.gp=gp;
    x="ben : i don't know i will think about it, but now i have to hurry!\n" +
            ...
            "ben :omg, omg !! i will be late today they will detain me from university. \n" +
            "(gp : ben picks his pendant : go near college , go inside college?)\n" +
            "ben uses that pendant and thinks his options where he should go , so that no one can see the power of the pendant.\n" +
            "he reached clg near and he walks into it where none has seen him.\n" +
